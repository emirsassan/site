...
<template>
  <section
    class="min-h-[calc(100vh-5rem)] flex items-center justify-center py-20 relative"
  >
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex flex-col-reverse md:flex-row items-center gap-12">
        <div class="flex-1 text-center md:text-left">
          <h1
            class="font-poppins font-bold text-4xl md:text-6xl text-text dark:text-dark-text mb-4"
          >
            Hello everyone 👋
          </h1>
        ...
        <div class="relative flex-1 flex justify-center mb-8 md:mb-0">
          <div
            class="w-48 h-48 md:w-64 md:h-64 rounded-full overflow-hidden border-4 border-primary dark:border-dark-accent relative z-10"
          >
            <img
              src="/pfp.jpeg"
              alt="Profile"
    ...
    >
      <button
        @click="scrollToAbout"
        class="text-text/80 hover:text-primary dark:text-dark-text/80 dark:hover:text-dark-primary transition-colors"
      >
        <svg
          class="w-6 h-6"
          fill="none"
